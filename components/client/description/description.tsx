    ...
    return (
        <div ref={description} className="px-20 mt-20 flex justify-center">
            <div className="max-w-[1400px] flex gap-12 relative">
                <p className="text-3xl gap-2 leading-[1.3]">
                ...
                <motion.p variants={opacity} animate={isInView ? "open" : "closed"} className="text-lg w-4/5 font-light">
                    The combination of my passion for design, code & interaction positions me in a unique place in the web design world.
                </motion.p>
                <div data-scroll data-scroll-speed={0.1} className="absolute top-[80%] left-[calc(100%-200px)] w-[180px] h-[180px] bg-[#1C1D20] text-white rounded-full flex items-center justify-center cursor-pointer">
                    <RoundedButton>
